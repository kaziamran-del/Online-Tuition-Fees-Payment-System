                    ...
                    <div class="col-md-12 col-sm-12"> 
                        ...
                        <form method="post" action="<?php echo e(route('regFee.store.data')); ?>">
                            ...
                            <div class="form-group">
                                Field Name <input type="text" name="field_name" class="from-control extra" placeholder="Enter Field Name" style="margin-left: 40px;" />
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\p400\resources\views/admin/registration/create.blade.php ENDPATH**/ ?>