			...
			<div class="reciept area">
				...
				<div class="row" style="float: right;">
					<div class="col-lg-12 col-md-12 col-sm-12">
						<a href="<?php echo e(route('payment.record',['id' => $data->student_id])); ?>" class="btn btn-sm btn-info">Record Info</a>
					</div>
				</div>

			<form id="payment_form" method="post" action="<?php echo e(route('temporary.save.data')); ?>">
						...
						<div class="col-md-12 col-sm-12">
							<div class="form-group row">
							   <label class="col-md-2 col-sm-2 control text-left" for="">Name of the Student </label>
								...
								<div class="col-md-10 col-sm-10">
									<input style="text-transform: capitalize;" name="student_name" type="text" value="<?php echo e($data->student_name); ?>" class="form-control text-money field_width" readonly="readonly"/>
								</div>
							</div>
							...
							<div class="form-group row">
							   <label class="col-md-2 col-sm-2 control text-left" for="">ID Number(9 digits) </label>
								...
								<div class="col-md-10 col-sm-10">
									<input id="" name="student_id" type="text" value="<?php echo e($data->student_id); ?>" class="form-control text-money field_width" readonly="readonly"/>
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-md-10 col-sm-10">
									<input style="text-transform: capitalize;" name="program_batch" type="text" value="<?php echo e($data->program_batch); ?>" class="form-control text-money field_width" readonly="readonly"/>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="form-group row">
								...
								<div class="col-lg-6 col-md-6 col-sm-4">
									<select class="form-control" id="season" multiple="multiple" name="payment_val[]">
										<option name="term_fee" data-value="<?php echo e($data->term_fee); ?>" value="Spring">Spring</option>
										<option name="term_fee" data-value="<?php echo e($data->term_fee); ?>" value="Summer">Summer</option>
										<option name="term_fee" data-value="<?php echo e($data->term_fee); ?>" value="Autumn">Autumn</option>
									</select>
								</div>
							...
							<div class="form-group row">
								...
								<div class="col-lg-6 col-md-6 col-sm-4">
									<select class="form-control select" id="monthSelect" multiple="multiple" name="payment_val[]">
										<option name="month_fee" data-latefee="200" data-value="<?php echo e($data->month_fee); ?>" value="January">January</option>
										<option name="month_fee" data-latefee="300" data-value="<?php echo e($data->month_fee); ?>" value="February">February</option>
										<option name="month_fee" data-latefee="200" data-value="<?php echo e($data->month_fee); ?>" value="March">March</option>
										<option name="month_fee" data-latefee="230" data-value="<?php echo e($data->month_fee); ?>" value="April">April</option>
										<option name="month_fee" data-latefee="500" data-value="<?php echo e($data->month_fee); ?>" value="May">May</option>
										<option name="month_fee" data-latefee="200" data-value="<?php echo e($data->month_fee); ?>" value="June">June</option>
										<option name="month_fee" data-latefee="100" data-value="<?php echo e($data->month_fee); ?>" value="July">July</option>
										<option name="month_fee" data-latefee="50" data-value="<?php echo e($data->month_fee); ?>" value="August">August</option>
										<option name="month_fee" data-latefee="90" data-value="<?php echo e($data->month_fee); ?>" value="September">September</option>
										<option name="month_fee" data-latefee="60" data-value="<?php echo e($data->month_fee); ?>" value="October">October</option>
										<option name="month_fee" data-latefee="0" data-value="<?php echo e($data->month_fee); ?>" value="November">November</option>
										<option name="month_fee" data-latefee="0" data-value="<?php echo e($data->month_fee); ?>" value="December">December</option>
									</select>
								</div>
							...
							<div class="form-group row">
								...
								<div class="col-lg-6 col-md-6 col-sm-4">
									<select class="form-control" id="readmission" multiple="multiple" name="payment_val[]">
										<option name="re_ad_fee" data-value="<?php echo e($data->re_ad_fee); ?>" value="Spring">Spring</option>
										<option name="re_ad_fee" data-value="<?php echo e($data->re_ad_fee); ?>" value="Summer">Summer</option>
										<option name="re_ad_fee" data-value="<?php echo e($data->re_ad_fee); ?>" value="Autumn">Autumn</option>
									</select>
								</div>
							...
							<div class="form-group row">
								...
								<div class="col-lg-6 col-md-6 col-sm-4">
									<select class="form-control" id="retake" name="payment_val[]">
										...
										<option name="retake_fee" data-value="<?php echo e($data->retake_fee); ?>" value="One Course">One Course</option>
										<option name="retake_fee" data-value="<?php echo e($data->retake_fee*2); ?>" value="Two Course">Two Course</option>
										<option name="retake_fee" data-value="<?php echo e($data->retake_fee*3); ?>" value="Three Course">Three Course</option>				
									</select>
								</div>
								<div class="col-lg-2 col-md-3 col-sm-4">
							...
							<div class="form-group row">
									...
									<div class="col-lg-6 col-md-6 col-sm-4">
										<select class="form-control" id="supply" name="payment_val[]">	
											...
											<option name="supply_fee" data-value="<?php echo e($data->supply_fee); ?>"  value="One Course">One Course</option>
											<option name="supply_fee" data-value="<?php echo e($data->supply_fee*2); ?>" value="Two Course">Two Course</option>
											<option name="supply_fee" data-value="<?php echo e($data->supply_fee*3); ?>" value="Three Course">Three Course</option>							
											<option name="supply_fee" data-value="<?php echo e($data->supply_fee*4); ?>" value="Four Course">Four Course</option>
											<option name="supply_fee" data-value="<?php echo e($data->supply_fee*5); ?>" value="Five Course">Five Course</option>
										</select>
									</div>
									<div class="col-lg-2 col-md-3 col-sm-4">
							...
							<div class="form-group row">
								...
								<div class="col-lg-6 col-md-6 col-sm-4">
									<select class="form-control" id="other" multiple="multiple" name="payment_val[]">				
										<option name="others_fee" data-value="<?php echo e($data->others_fee); ?>" value="Transcript">Transcript</option>
										<option name="others_fee" data-value="<?php echo e($data->others_fee); ?>" value="Provisional Certificate">Provisional Certificate</option>
										<option name="others_fee" data-value="<?php echo e($data->others_fee); ?>" value="Original Certificate">Original Certificate</option>
									</select>
								</div>
								<div class="col-lg-2 col-md-3 col-sm-4">
							...
							<div class="form-group row">
								...
								<div class="col-lg-6 col-md-6 col-sm-4">											
									<select class="form-control select" id="hostelRent" multiple="multiple" name="payment_val[]">			
										<option name="hostel_rent" data-value="<?php echo e($data->hostel_rent); ?>" value="January">January</option>
										<option name="hostel_rent" data-value="<?php echo e($data->hostel_rent); ?>" value="February">February</option>
										<option name="hostel_rent" data-value="<?php echo e($data->hostel_rent); ?>" value="March">March</option>
										<option name="hostel_rent" data-value="<?php echo e($data->hostel_rent); ?>" value="April">April</option>
										<option name="hostel_rent" data-value="<?php echo e($data->hostel_rent); ?>" value="May">May</option>
										<option name="hostel_rent" data-value="<?php echo e($data->hostel_rent); ?>" value="June">June</option>
										<option name="hostel_rent" data-value="<?php echo e($data->hostel_rent); ?>" value="July">July</option>
										<option name="hostel_rent" data-value="<?php echo e($data->hostel_rent); ?>" value="August">August</option>
										<option name="hostel_rent" data-value="<?php echo e($data->hostel_rent); ?>" value="September">September</option>
										<option name="hostel_rent" data-value="<?php echo e($data->hostel_rent); ?>" value="October">October</option>
										<option name="hostel_rent" data-value="<?php echo e($data->hostel_rent); ?>" value="November">November</option>
										<option name="hostel_rent" data-value="<?php echo e($data->hostel_rent); ?>" value="December">December</option>
									</select>
								</div>
								<div class="col-lg-2 col-md-3 col-sm-4">
							...
							<div class="form-group row">
								...
								<div class="col-lg-6 col-md-6 col-sm-4">
									<select class="form-control" id="miscellaneous" multiple="multiple" name="payment_val[]">
										<option name="miscellaneous_fee" data-value="<?php echo e($data->miscellaneous_fee); ?>" value="Spring">Spring</option>
										<option name="miscellaneous_fee" data-value="<?php echo e($data->miscellaneous_fee); ?>" value="Summer">Summer</option>
										<option name="miscellaneous_fee" data-value="<?php echo e($data->miscellaneous_fee); ?>" value="Autumn">Autumn</option>
									</select>
								</div>
						...
						<div class="col-lg-6 col-md-6 col-sm-12">
							<div class="form-group">
				              <label class="control" for="">Student's Signature</label>					
								<div class="form-group">
									<label for="">Mobile No : <?php echo e($data->mobile_no); ?></label>		
								</div>
				            </div>
						</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('front_end.frontend_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\p400\resources\views/front_end/pages/payment_bill.blade.php ENDPATH**/ ?>