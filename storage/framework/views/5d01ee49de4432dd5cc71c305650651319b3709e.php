        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9" align="left" style="margin-top: 10px;">                       
                     <a href="<?php echo e(route('admin.pages.create')); ?>" class="btn btn-primary">Register ID</a>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\p400\resources\views/admin/pages/index.blade.php ENDPATH**/ ?>