            	...
            	<form method="post" action="<?php echo e(route('update.registration.data')); ?>">
                    ...
                    <input type="hidden" value="<?php echo e($regFees->id); ?>" name="id" />
                        ...
                        <div class="form-group">
                            Field Name <input type="text" name="field_name" class="from-control extra"  value="<?php echo e($regFees->field_name); ?>" style="margin-left: 40px;"/>
                        </div>
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\p400\resources\views/admin/registration/edit.blade.php ENDPATH**/ ?>